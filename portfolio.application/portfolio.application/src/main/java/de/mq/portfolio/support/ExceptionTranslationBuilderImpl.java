...
public class ExceptionTranslationBuilderImpl<R, T extends AutoCloseable> implements ExceptionTranslationBuilder<R, T>  {
	...
	enum Type {
		ReturningWithResource(true),
		ReturningWithoutResource(false),
		VoidWithResource(true),
		VoidWithoutResource(false);
	...
	/* (non-Javadoc)
	 * @see de.mq.portfolio.support.ExceptionTranslationBuilder#withStatement(java.util.function.Function)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.mq.portfolio.support.ExceptionTranslationBuilder#withStatement(java.util.function.Supplier)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.mq.portfolio.support.ExceptionTranslationBuilder#withStatement(java.util.function.Consumer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.mq.portfolio.support.ExceptionTranslationBuilder#withStatement(de.mq.portfolio.support.ExceptionTranslationBuilderImpl.Command)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.mq.portfolio.support.ExceptionTranslationBuilder#withResource(java.util.function.Supplier)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.mq.portfolio.support.ExceptionTranslationBuilder#withTranslation(java.lang.Class, java.lang.Class)
	 */
	@Override
